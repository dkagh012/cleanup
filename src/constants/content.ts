  ...
  items: [
    {
      ...
      description: '만들었던 기능이 예상대로 작동하지 않거나 <br/> 특정 상황에서 오류가 발생',
    },
    {
      icon: '/main/time.png',
      title: '유지·운영이 어려움',
      description: '코드가 뒤엉켜 있어 작은 기능 하나만 수정해도<br/> 다른 부분에서 예기치 않은 문제가 발생함',
    },
    {
      icon: '/main/box.png',
      title: '확장·추가 개발이 어려움',
      description: '새로운 기능을 만들고 싶어도 기존 코드와 충돌하거나 <br/> 개발 속도가 점점 느려져 서비스 확장이 어려워짐',
    },
  ],
} as const;
...
export const PROCESS_SECTION = {
  ...
  steps: [
    { 
      ...
      description: '서비스 전체 구조를 빠르게 스캔해 문제 영역을 구분합니다.',
      details: '(코드 구조·오류·중복·성능·보안 1차 점검)',
    },
    {
      number: '2',
      title: '상세 분석 & 기술 부채 분류',
      description: '발견된 문제들을 카테고리별로 정밀 분류하고 영향도를 평가합니다.',
      details: '(영향도 분석·우선순위 결정·리스크 구간 도출)',
    },
    {
      number: '3',
      title: '아키텍처 재정리',
      description: '서비스가 안정적으로 돌아가도록 폴더 구조, 모듈, 의존성을 재배치합니다.',
      details: '(구조 정비·필요한 경우 부분적 재구현)',
    },
    {
      number: '4',
      title: '핵심 기능 클린업',
      description: '복잡하거나 깨진 기능을 안정화하고 로직을 재정비합니다.',
      details: '(중복 제거·로직 간소화·오류 수정·API 정리)',
    },
    {
      number: '5',
      title: '테스트·보안·성능 개선',
      description: '테스트를 추가하고 기본 보안 점검 및 성능 최적화를 진행합니다.',
      details: '(테스트 코드·취약점 점검·속도 개선)',
    },
    {
      number: '6',
      title: '배포·운영 자동화 & 문서화',
      description: '운영 효율을 높이기 위해 배포 환경을 정리하고 필요한 문서를 제공합니다.',
